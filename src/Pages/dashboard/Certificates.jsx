...
export default function Certificates() {
  ...
  const uploadImage = async () => {
    ...
    // Use lowercase 'img' to match typical DB column names (avoid PGRST204 schema cache error)
            ...
            <div className="flex items-center justify-between gap-3 flex-wrap">
              ...
              <div className="flex gap-2 shrink-0">
                ...
                <button onClick={uploadImage} disabled={uploading} className="relative group/u">
                  <div className="absolute -inset-0.5 rounded-xl opacity-60 blur group-hover/u:opacity-100 transition duration-300" style={{ background: 'linear-gradient(90deg, var(--color-primary-dark), var(--color-primary-light))' }} />
                  <div className="relative flex items-center gap-2 px-4 py-1.5 rounded-xl border border-white/10" style={{ backgroundColor: 'var(--color-backdrop-base)' }}>
